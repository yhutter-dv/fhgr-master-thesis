...
\begin{figure}[H]
    ...
    \includegraphics[width=.4\linewidth]{content/00_assets/cdlod_morph_areas.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=.4\linewidth]{content/00_assets/cdlod_vertex_morphing.png}
